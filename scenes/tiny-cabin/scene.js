import { TAU, rand, clamp, paintToCanvas, loadImage } from '../../core.js';
...
export async function preloadTinyCabinAssets() {
  await Promise.all([preloadDeerSprites(), preloadOwlSprites(), preloadRabbitSprites(), preloadWindowShadow()]);
}

export { SnowOverlay, SmokeOverlay, CabinEventsOverlay, AuroraShimmerOverlay, WindowGlowOverlay, StarsTwinkleOverlay, EV_NAMES_CABIN };
